...
def login():
    browser.get("http://hoctainha.vn/")
    page_source = browser.page_source
    soup = BeautifulSoup(page_source, 'lxml')
    wait = WebDriverWait(browser, 2)
    wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="spanLoginInfo"]'))).click()
    wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="txtLoginEmail"]'))).send_keys(
        "huynguyen104798@gmail.com")
    wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="txtLoginPass"]'))).send_keys("nguyenvanhuy")
    wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="ctl00_ContentPlaceHolder1_btnLogin"]'))).click()
    sleep(1)
...
def get_vuihocvn():
    ...
    with open(r'/Get_questions_iq/Get_questions_iq/spiders/JSon/hoctainhavntest.json', 'r') as j:
    ...
    for link in list_link:
            ...
            for i in List_of_source:
                ...
                try:
                    if title_local.find("img"):
                        ...
                        filepath = r'/Get_questions_iq/Get_questions_iq/spiders/hoctainha/image/'
        ...
        filePath = r'/Get_questions_iq/Get_questions_iq/spiders/hoctainha/json/'
