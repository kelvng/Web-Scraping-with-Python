...
def download():
    products_data = pd.read_csv(r'E:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\hoc247net\hoc247url\hoc247tulieudownload.csv')
    ...
    for link in tqdm(list_link):
        ...
        if soup.find('span', class_="i-download") == None:
            ...
            products_data.to_csv(
                r"E:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\hoc247net\hoc247url\hoc247tulieudownload.csv")
        ...
        print(smallfolder)
        newpath = r'E:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\hoc247net\Download\hoc247net/' + bigfolder + '/' + smallfolder
        ...
        options.add_argument(
            "user-data-dir=C:\\Users\\Administrator\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 2")
        browser = webdriver.Chrome(r'E:\PycharmProjects\Source\chromedriver.exe', options=options)
        ...
        products_data.to_csv(r"E:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\hoc247net\hoc247url\hoc247tulieudownload.csv")
download()