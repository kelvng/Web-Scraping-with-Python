...
List_onedirve = []
def download():
    products_data = pd.read_csv(r'F:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\stem-steam\url\thuvienstem-steamcomdeep=6.csv')
    ...
    for link in tqdm(list_link):
        ...
        products_data.to_csv(r"F:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\stem-steam\url\thuvienstem-steamcomdeep=6.csv")
download()
filename = 'stemsteam'
myUUID = uuid.uuid4()
