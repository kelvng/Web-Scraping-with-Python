...
def get_Tienganh():
    ...
    with open(r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\JSon\jsontestbaitap123\tienganhtest.json.json', 'r') as j:
    ...
    for link in list_link:
        ...
        list_title = []
        print(data)
        List_of_source = dapan_source.findAll(True, {'class':['lb_question_item pagi_page_1', 'lb_question_item pagi_page_2','lb_question_item pagi_page_3', 'lb_question_item pagi_page_4', 'lb_question_item pagi_page_5', 'lb_question_item pagi_page_6']})
        ...
        for i in List_of_source:
            ...
            try:
                if title_local.find("img"):
                    ...
                    filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\Tienganh\iamge_ask'
            ...
            for s in answer_loca:
                ...
                try:
                    if answer.find("img"):
                        ...
                        filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\Tienganh\image_answer/'
        ...
        filePath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\Tienganh/'
