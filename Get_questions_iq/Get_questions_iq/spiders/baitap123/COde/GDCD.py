...
def get_gdcd():
    ...
    # with open(r'C:\Users\pycha\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\JSon\jsontestbaitap123/GDCDtest.json', 'r') as j:
    ...
    for link in list_link:
        ...
        for i in List_of_source:
            ...
            try:
                if title_local.find("img"):
                    ...
                    filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\GDCD\iamge_ask'
            ...
            for s in answer_loca:
                ...
                try:
                    if answer.find("img"):
                        ...
                        filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\GDCD\image_answer/'
        ...
        filePath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\GDCD/'
