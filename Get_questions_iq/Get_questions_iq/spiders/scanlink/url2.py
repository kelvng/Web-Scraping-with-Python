            ...
            if deep <= 4:
                ...
                for s in soup.find_all('a'):
                    try:
                        link = s['href']
                        if 'http' not in link:
                            link = 'https://www.nettruyenme.com' + link
...
# Vị trí lưuhttps://tailieuplus.net/ file
url = url.replace("https://", "")
filename = url.replace(".com/","") + "deep=5"

with open('nettruyenme.csv', 'w',  newline = '',encoding="utf-8") as file_output:
    headers = ['link']
