...
def get_tracnghiemnet():
    ...
    products_data = pd.read_csv(
        r'H:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\tracnghiemnet\tracnghiemneturl\Tracnghiemcntt.csv')

    #products_data['download'] = np.nan
    list_link = products_data.loc[products_data['download'] != 'Yes']['link'].head(50)
    #50
    #link = ['https://tracnghiem.net/de-thi/de-thi-giua-hk2-mon-vat-ly-11-nam-2021-2022-4742.html']
    dem =40
    #dem = 40 +150
    for link in tqdm(list_link):
        ...
        for i in lstlink:
            ...
            if 'https://tracnghiem' in url:
                ...
                ask_decode = ''.join(map(str, ask_decode))
        ...
        for g in range(len(list_url)):
            ...
            page_source = req.text
            soup = BeautifulSoup(page_source, 'lxml')
            box_ask = soup.find('div', class_="d9Box part-item detail question-detail")
            ...
            try:
                if content_decode.find("img"):
                    ...
                    filepath = r'H:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\tracnghiemnet\image\image_ask/'
            ...
            for j in answer_local:
                ...
                try:
                    if answer.find("img"):
                        ...
                        filepath = r'H:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\tracnghiemnet\image\image_answer/'
        ...
        filePath = r'H:\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\tracnghiemnet\Json/'
        print(filename)
