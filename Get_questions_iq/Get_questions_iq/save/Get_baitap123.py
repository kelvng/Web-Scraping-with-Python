...
def get_link_source():
    dem = 0
    cau = 0
    # with open(r"C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\JSon\selector.json",
    #           "r") as f:
    #     selectdata = json.load(f.read())
    # selector = selectdata["spidername"][0]["Selector"]
    ...
    products_data = pd.read_csv(r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\link.csv')
    for link in tqdm(products_data['link'].tolist()):
        ...
        for i in List_of_source:
            ...
            try:
                if title_local.find("img"):
                    ...
                    filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\image\img_ask/'
            ...
            for s in answer_loca:
                ...
                try:
                    if answer.find("img"):
                        ...
                        filepath = r'C:\Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\image\Img_answer/'
        ...
        try:
            ...
            filePath = r'C:/Users\Admin\PycharmProjects\Source\Get_questions_iq\Get_questions_iq\spiders\baitap123\QUESTIONIQ/'
