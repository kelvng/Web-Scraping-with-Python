...
credential = open(r'F:\PycharmProjects\Source\LinkedInScraping-master\credential\credentials5.txt')
...
url_upload = 'http://localhost:6023/PythonCrawler/GetDataLinkedin'
...
for datalinkedin in tqdm(element_data):
    ProfileUrl = datalinkedin['ProfileUrl']
    ...
    try:
        ...
        Certifications = ''
        Activity = ''
        print('- Accessing profile: ', datalinkedin['ProfileUrl'])
        sleep(3)
        page_source = driver.page_source
        info_div = BeautifulSoup(page_source, "html.parser")
        info_div = info_div.find('body')
        ...
        #profile url
        Linkedin = datalinkedin['ProfileUrl']
        print(Linkedin)
        # contact
        # Contact =
        ...
        print(jsondata)
        url_upload = "http://117.6.131.222:8989/PythonCrawler/InsertLinkedinInfor"
