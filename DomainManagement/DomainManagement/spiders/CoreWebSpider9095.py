...
def outer_func():
    class url_obj:
        ...
        def GetContent(self, url, selector, keyword,SessionCode):
            try:
                ...
                if linkpostdata != '' and contentdata != '' and headerdata != '' and str(list_str) != '':
                    ...
                    print(data)
                    url_upload = "https://dieuhanh.vatco.vn/PythonCrawler/InsertCrawlerCrawlerSessionContent"
                    ...
                    if resp.ok:
                        ...
                        data1 = {
                            'fileCode':IdData['ID'],
                            'content': text.strip(),
                            'pathIndex': r'D:\wwwroot\III.SWORK.VATCO 2.2 NEW\wwwroot\uploads\repository\IINDEX_SEARCH CRAWL',
                            #D:\wwwroot\III.SWORK.VATCO 2.2 NEW\wwwroot\uploads\repository\IINDEX_SEARCH CRAWL
                            'UrlPost':url,
                            'IdentifierCode':SessionCode,
                        }
                        print(data1)
                        url_upload = 'https://dieuhanh.vatco.vn/PythonCrawler/PythonIndexContent'
        ...
        def upload_data(self, Document,SessionCode):
            ...
            filename = SessionCode +'_' +mystr[0:5] + '.docx'
        ...
        async def main(self):
            ...
            self.upload_data(document, self.SessionCode)
